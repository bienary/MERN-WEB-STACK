...
<img width="1016" height="149" alt="Screenshot From 2025-09-19 00-56-09" src="https://github.com/user-attachments/assets/98464663-d1c9-4fe0-92ce-8e01419d9d86" />
...
- you need to cd into your client from your terminal and run `yarn add axios` or `npm install axios`.
...
vi ListTodo.js
```
- In the `ListTodo.js` write the following code
```
...
- Exit the editor after writting.

- In the `src` directory open the `App.css`
```
vi App.css
```
- Write the following code into `App.css`:
```
.App {
text-align: center;
